...
@inline function nchilds(system::AbstractSystem{2}, refinement_pattern::TriangularSplitting)
...
@inline function nchilds(system::AbstractSystem{2}, refinement_pattern::HexagonalSplitting)
